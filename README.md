...
**AI 이용 한도 해제와 현재·누적 접속 표시를 운영 배포했습니다.**
현재 릴리스는 `release-20260912T084126Z` / `jeju-3d:23`입니다.
...
앱 Node 637개·Python 197개가 통과했고, 선택 검사 4개는 별도 브라우저 검사와 구분해 기록했습니다.
실제 AI 세 요청이 동시에 응답을 완료했습니다. 일부 장소·가족 추천의 검색 결과 개선은 후속 작업입니다.
[AI 한도·접속 표시 최신 배포 기록](docs/ai-presence-release-2026-09-12.md) ·
