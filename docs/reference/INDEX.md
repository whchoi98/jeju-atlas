...
| Workshop preconfiguration | [core requirements](../../workshop/requirements-core.txt), [full helper requirements](../../workshop/requirements.txt) | [Node, Python and AgentCore CLI installation](../../workshop/reference/preconfiguration.md) |
| Workshop API keys | [private input](../../workshop/scripts/workshop_env.py), [owned SSM binding](../../workshop/scripts/key_binding.py), [advanced Guide binding](../../workshop/scripts/agent_key.py) | [Bedrock keys and optional integrations](../../workshop/reference/keys-and-integrations.md), [installation skill](../../skills/jeju-atlas-install/SKILL.md), [resume after errors](../../skills/jeju-atlas-install/references/recovery.md) |
| Optional Codex and Claude Code HUD | [HUD guide](../../workshop/reference/hud-setup.md), [Claude Code plugins](../../workshop/reference/preconfiguration.md#선택-claude-code-hud와-플러그인) | [Chapter 01](../../workshop/chapters/01-setup.md), [assistant environments](../../workshop/reference/ai-cli-environments.md) |
...
| Workshop Sonnet verification | [model configuration](../../workshop/scripts/model_config.py), [explicit real-model check](../../workshop/scripts/model_check.py) | [Account and workspace](../../workshop/chapters/02-aws-environment.md), [official references](../../workshop/reference/official-guide-review.md) |
...
| 워크숍 API 키 | [숨김 입력](../../workshop/scripts/workshop_env.py), [소유 SSM 연결](../../workshop/scripts/key_binding.py), [심화 Guide 연결](../../workshop/scripts/agent_key.py) | [Bedrock API 키와 선택 연동](../../workshop/reference/keys-and-integrations.md), [설치 스킬](../../skills/jeju-atlas-install/SKILL.md), [오류별 재개](../../skills/jeju-atlas-install/references/recovery.md) |
| 선택 Codex, Claude Code HUD | [HUD 가이드](../../workshop/reference/hud-setup.md), [Claude Code 플러그인](../../workshop/reference/preconfiguration.md#선택-claude-code-hud와-플러그인) | [01장](../../workshop/chapters/01-setup.md), [Agentic AI 코딩 어시스턴트 환경](../../workshop/reference/ai-cli-environments.md) |
...
| 워크숍 Sonnet 검증 | [모델 설정](../../workshop/scripts/model_config.py), [명시적 실제 호출](../../workshop/scripts/model_check.py) | [계정과 작업 폴더](../../workshop/chapters/02-aws-environment.md), [공식 문서 대조](../../workshop/reference/official-guide-review.md) |
