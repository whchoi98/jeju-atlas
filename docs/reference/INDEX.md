...
| 워크숍 API 키 | [숨김 입력](../../workshop/scripts/workshop_env.py), [소유 SSM 연결](../../workshop/scripts/key_binding.py), [심화 Guide 연결](../../workshop/scripts/agent_key.py) | [Bedrock API 키와 선택 연동](../../workshop/reference/keys-and-integrations.md), [설치 스킬](../../skills/jeju-atlas-install/SKILL.md) |
