...
실습 계정과 participant가 지정되어 있는지 확인하세요. lab.py의 init/doctor/discover/info로 기존 VPC·두 AZ의 public/private subnet·NAT·CloudFront Prefix List를 확인하세요. 계정이 다르면 멈추고 profile을 확인하세요. 새 네트워크를 만들거나 운영 라우트를 변경하지 마세요.
