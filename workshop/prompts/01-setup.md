...
현재 Node 24, Python/uv, Docker Server, AWS CLI, @aws/agentcore 0.28.1, Codex 버전을 확인하세요. 누락 도구와 설치할 정확한 명령을 먼저 제시하세요. 원본 프로젝트의 전역 도구를 바꾸지 말고 실습 로컬 설치 경로를 사용하세요. 로그인 자료를 읽지 마세요.
