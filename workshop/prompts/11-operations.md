...
내 operations/data/edge 스택의 알람, dashboard, topic, heartbeat를 확인하세요. 일일/시간/동시 한도, ECR 검사 완료, 로그 보관과 내용 capture 비활성화를 확인하세요. SNS 수신은 학습자가 선택한 본인 채널의 확인 절차와 구분하세요. 계정 전체 설정이나 다른 프로젝트 IAM 정책을 임의 변경하지 마세요.
