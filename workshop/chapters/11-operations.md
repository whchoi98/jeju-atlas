...
운영자가 앱 사용량 제한을 해제하려면 준비된 실습 workspace의 `infra/production.json`에서 `GuideLimitsEnabled`를 문자열 `"false"`로 바꾸고 `plan-app`의 변경 내용을 검토해 배포합니다.\
...
Agentic AI 코딩 어시스턴트 프롬프트: [11, 관측, 운영](../prompts/11-operations.md)
