...
def package_handbook(site, output):
    ...
    instructions = (
        ...
        "4. 명령과 선택한 Agentic AI 코딩 어시스턴트는 준비된 EC2의 VSCode Server 터미널에서 실행합니다.\n"
        "5. EC2에는 제주 아틀라스 전체 Git 저장소가 필요합니다.\n"
        "6. 사전 설치 후 본 실습은 00~04장 100분과 여유 20분입니다. 05장 이후는 추가 시간의 심화 자료입니다.\n"
        "7. Bedrock 단기키는 EC2의 본인 터미널에서 .env에 숨김 입력합니다. 카카오와 관광공사 키는 배포 후 선택 입력합니다.\n\n"
        "이 묶음은 읽기용입니다. AWS 키, 실습 설정, 배포 상태, DB, 런타임 ZIP은 포함하지 않습니다.\n"
        "prompts/*.md는 EC2에서 선택한 Agentic AI 코딩 어시스턴트에 전달할 공통 프롬프트 카드입니다.\n"
